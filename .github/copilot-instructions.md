...
Primary development is with Django and server-rendered HTML templates, using JavaScript and CSS for interactivity and styling.
...
API endpoints and a React/TypeScript frontend will be developed in a later phase.
...
**templates/**: Global and app-specific HTML templates (Django Templating Language)
**static/**: Global and app-specific static files (JS, CSS, images)
**api/** (future): Django REST Framework endpoints for React/TypeScript frontend
**frontend/** (future): React/TypeScript SPA (decoupled, API-driven)
